...
class ActivityMagthGameMultiplied : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_magth_game_multiplied)
    ...
    private fun FIntentData(Score:Int){
        val magthGamePlus: Intent = Intent(this,ActivityMagthGameMultiplied02::class.java).apply {
