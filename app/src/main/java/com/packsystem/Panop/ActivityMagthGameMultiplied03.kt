...
class ActivityMagthGameMultiplied03 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_magth_game_multiplied03)
    ...
    private fun FIntentData(Score:Int){
        val magthGamePlus: Intent = Intent(this,ActivityMagthGameMultiplied04::class.java).apply {
