...
class ActivityMagthGameMultiplied02 : AppCompatActivity() {
    ...
    private var number1:Int = Random.nextInt(1, 12)
    private var number2:Int = Random.nextInt(1, 12)
    private var number3:Int = number1 * number2
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_magth_game_multiplied02)
    ...
    private fun NumberRandom(numResult:Int): Int {
        ...
        when(num){
            1 -> return num + Random.nextInt(30)
            2 -> return num - Random.nextInt(60)
            3 -> return num / 2
            else -> return num + Random.nextInt(10, 90)
        }
    }

    private fun FIntentData(Score:Int){
        val magthGamePlus: Intent = Intent(this,ActivityMagthGameMultiplied03::class.java).apply {
