...
class ActivityMagthGamePlus : AppCompatActivity() {
    ...
    private var mathNumberResult:Int = nextInt(1,4)
    private var number1:Int = nextInt(1,100)
    private var number2:Int = nextInt(1,100)
    private var number3:Int = number1 + number2
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_magth_game_plus)
    ...
    private fun NumberRandom(numResult:Int): Int {
        var num:Int = nextInt(1,4)
        when(num){
            1 -> return num + nextInt(40)
            2 -> return num - nextInt(40)
            3 -> return num / 2
            else -> return num + nextInt(50 ,90)
        }
    }
    private fun FIntentData(Score:Int){
        val magthGamePlus: Intent = Intent(this,ActivityMagthGamePlus02::class.java).apply {
