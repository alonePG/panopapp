...
class ActivityMagthGameMinus04 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_magth_game_minus04)
    ...
    private fun FIntentData(Score:Int){
        val magthGamePlus: Intent = Intent(this,ActivityMagthGameMinus05::class.java).apply {
