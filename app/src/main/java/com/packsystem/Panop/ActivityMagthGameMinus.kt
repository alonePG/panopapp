...
class ActivityMagthGameMinus : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_magth_game_minus)
    ...
    private fun NumberRandom(numResult:Int): Int {
        ...
        when(num){
            ...
            2 -> return num - Random.nextInt(40)
            3 -> return num / 2
            else -> return num + Random.nextInt(50, 90)
        }
    }
    private fun FIntentData(Score:Int){
        val magthGamePlus: Intent = Intent(this,ActivityMagthGameMinus02::class.java).apply {
